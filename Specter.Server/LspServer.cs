...
internal sealed class TextDocumentSyncHandler : TextDocumentSyncHandlerBase
{
    ...
    private static LspDiagnosticSeverity MapSeverity(Specter.DiagnosticSeverity severity)
    {
        return severity switch
        {
            Specter.DiagnosticSeverity.Error => LspDiagnosticSeverity.Error,
            Specter.DiagnosticSeverity.Warning => LspDiagnosticSeverity.Warning,
            Specter.DiagnosticSeverity.Information => LspDiagnosticSeverity.Information,
