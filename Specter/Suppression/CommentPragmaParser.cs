...
namespace Specter.Suppression
{
    /// <summary>
    /// Parses comment tokens for suppression pragmas:
    /// - Line: <c># specter-suppress RuleName</c> (suppresses next non-comment line)
    /// - Inline: <c>$x = 1 # specter-suppress RuleName</c> (suppresses current line)
    /// - Block begin: <c># specter-suppress-begin RuleName</c>
    /// - Block end: <c># specter-suppress-end RuleName</c>
    /// </summary>
    internal static class CommentPragmaParser
    {
        private const string PragmaPrefix = "specter-suppress";
        private const string BlockBeginPrefix = "specter-suppress-begin";
        private const string BlockEndPrefix = "specter-suppress-end";
