...
namespace Specter.Tools
{
    public static class SpecialVariables
    {
        ...
        {
            foreach (string specialVariable in SpecialVariables.InitializedVariables)
            {
                if (unscopedVariableName.Equals(specialVariable, StringComparison.OrdinalIgnoreCase))
                {
                    return true;
                }
            }
